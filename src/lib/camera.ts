...
export async function getCameraCapabilities(
	...
	try {
		...
		if (capabilities.frameRate && capabilities.frameRate.min !== undefined && capabilities.frameRate.max !== undefined) {
		...
		if (capabilities.aspectRatio && capabilities.aspectRatio.min !== undefined && capabilities.aspectRatio.max !== undefined) {
		...
		if (capabilities.exposureCompensation) {
			cameraCapabilities.exposureCompensation = capabilities.exposureCompensation;
		}
		...
		if (capabilities.height && capabilities.height.min !== undefined && capabilities.height.max !== undefined) {
		...
		if (capabilities.width && capabilities.width.min !== undefined && capabilities.width.max !== undefined) {
	...
	try {
		...
		if (settings) {
			...
			if (settings.exposureCompensation !== undefined) {
				advancedConstraints.exposureCompensation = settings.exposureCompensation;
			}
